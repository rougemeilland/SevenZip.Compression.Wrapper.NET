...
HRESULT CompressCodecsInfo::Create(const wchar_t* locationPath, CompressCodecsInfo** obj)
{
    *obj = nullptr;
...
HRESULT __stdcall CompressCodecsInfo::GetProperty(UInt32 index, PROPID propID, PROPVARIANT* value) throw()
{
