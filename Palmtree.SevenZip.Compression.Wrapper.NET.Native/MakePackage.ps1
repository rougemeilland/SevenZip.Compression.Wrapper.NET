...
try {
    ...
    Copy-Item (Join-Path $baseDirectory "Native.target") -Destination $packagePath
    Set-Location $packagePath
    $process = (Start-Process -FilePath "nuget" -ArgumentList "pack Palmtree.SevenZip.Compression.Wrapper.NET.Native.nuspec -OutputDirectory ../../bin/Debug" -NoNewWindow -PassThru)
