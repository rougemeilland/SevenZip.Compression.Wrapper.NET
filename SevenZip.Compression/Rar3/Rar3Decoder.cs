...
namespace SevenZip.Compression.Rar3
{
        ...
        : IDisposable
    {
        ...
        /// </summary>
        public const Int32 RAR3_CONTENT_PROPERTY_SIZE = 1;

        private readonly ICompressCoder _compressCoder;

        private bool _isDisposed;

        private Rar3Decoder(ICompressCoder compressCoder)
        {
            _isDisposed = false;
        ...
        public static Rar3Decoder Create(Rar3DecoderProperties properties, ReadOnlySpan<Byte> contentProperties)
        {
            ...
            try
            {
                compressCoder = CompressCodecsInfo.CreateCompressCoder("Rar3", CoderType.Decoder);
