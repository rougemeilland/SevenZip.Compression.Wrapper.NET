...
namespace SevenZip.Compression.Rar2
{
        ...
        : IDisposable
    {
        ...
        /// </summary>
        public const Int32 RAR2_CONTENT_PROPERTY_SIZE = 1;

        private readonly ICompressCoder _compressCoder;

        private bool _isDisposed;

        private Rar2Decoder(ICompressCoder compressCoder)
        {
            _isDisposed = false;
        ...
        public static Rar2Decoder Create(Rar2DecoderProperties properties, ReadOnlySpan<Byte> contentProperties)
        {
            ...
            try
            {
                compressCoder = CompressCodecsInfo.CreateCompressCoder("Rar2", CoderType.Decoder);
