...
namespace SevenZip.Compression.Bzip2
{
    ...
    public class Bzip2Encoder
        : CompressCoder
    {
        private Bzip2Encoder(ICompressCoder compressCoder)
            : base(compressCoder)
        {
        }
        ...
        /// </exception>
        public static Bzip2Encoder Create(Bzip2EncoderProperties properties)
        {
            ...
            try
            {
                compressCoder = CompressCodecsInfo.CreateCompressCoder("BZip2", CoderType.Encoder);
                ...
                var coder = new Bzip2Encoder(compressCoder);
                success = true;
                return coder;
            }
            finally
