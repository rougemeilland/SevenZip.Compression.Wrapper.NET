...
namespace SevenZip.Compression.Rar5
{
        ...
        : IDisposable
    {
        ...
        /// </summary>
        public const Int32 RAR5_CONTENT_PROPERTY_SIZE = 2;

        private readonly ICompressCoder _compressCoder;

        private bool _isDisposed;

        private Rar5Decoder(ICompressCoder compressCoder)
        {
            _isDisposed = false;
        ...
        public static Rar5Decoder Create(Rar5DecoderProperties properties, ReadOnlySpan<Byte> contentProperties)
        {
            ...
            try
            {
                compressCoder = CompressCodecsInfo.CreateCompressCoder("Rar5", CoderType.Decoder);
