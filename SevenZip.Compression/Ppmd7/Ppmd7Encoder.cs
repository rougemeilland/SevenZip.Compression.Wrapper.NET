...
namespace SevenZip.Compression.Ppmd7
{
    ...
    {
        /// <summary>
        /// The length of the property to embed in the compressed stream in PPMd7 format.
        /// </summary>
        ...
        private Ppmd7Encoder(ICompressCoder compressCoder, ICompressWriteCoderProperties compressWriteCoderProperties)
        {
            _isDisposed = false;
        ...
        public static Ppmd7Encoder Create(Ppmd7EncoderProperties properties)
        {
            ...
            try
            {
                compressCoder = CompressCodecsInfo.CreateCompressCoder("PPMD", CoderType.Encoder);
