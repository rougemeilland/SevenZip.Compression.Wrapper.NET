...
namespace SevenZip.Compression.Lzma2
{
        ...
        : IDisposable
    {
        ...
        private Lzma2Encoder(ICompressCoder compressCoder, ICompressWriteCoderProperties compressWriteCoderProperties)
        {
            _isDisposed = false;
        ...
        public static Lzma2Encoder Create(Lzma2EncoderProperties properties)
        {
            ...
            try
            {
                compressCoder = CompressCodecsInfo.CreateCompressCoder("LZMA2", CoderType.Encoder);
