...
{
    class WrapperISequentialOutStreamAsStream
        : Stream
    {
        private readonly ISequentialOutStream _sourceStream;

        public WrapperISequentialOutStreamAsStream(ISequentialOutStream sourceStream)
        {
        ...
        public override void Write(Byte[] buffer, Int32 offset, Int32 count)
        {
            ...
            _sourceStream.WriteBytes(new Span<Byte>(buffer, offset, count));
        }
    }
}
