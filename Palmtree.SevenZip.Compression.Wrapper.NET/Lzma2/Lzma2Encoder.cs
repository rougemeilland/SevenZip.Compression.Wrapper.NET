...
{
    /// <summary>
    /// A class of LZMA2 encoders.
    /// </summary>
    public class Lzma2Encoder
        : IDisposable, ICompressCoder
    {
        ...
        private Lzma2Encoder(CompressCoder compressCoder, CompressWriteCoderProperties compressWriteCoderProperties)
        {
            _isDisposed = false;
        ...
        /// <summary>
        /// Create an instance of <see cref="Lzma2Encoder"/> with default properties.
        /// </summary>
        /// <returns>
        /// It is an instance of <see cref="Lzma2Encoder"/> created.
        /// </returns>
        public static Lzma2Encoder CreateEncoder() => CreateEncoder(new Lzma2EncoderProperties());

        /// <summary>
        /// Create an instance of <see cref="Lzma2Encoder"/>.
        /// </summary>
        /// <param name="properties">
        /// Set a container object with properties that specify the behavior of the LZMA2 encoder.
        /// </param>
        /// <returns>
        /// It is an instance of <see cref="Lzma2Encoder"/> created.
        /// </returns>
        /// <exception cref="ArgumentNullException"><paramref name="properties"/> is null.</exception>
        public static Lzma2Encoder CreateEncoder(Lzma2EncoderProperties properties)
        {
            ...
            var compressSetCoderPropertiesOpt = (CompressSetCoderPropertiesOpt?)null;
            var success = false;
            try
            {
                ...
                compressSetCoderPropertiesOpt = (CompressSetCoderPropertiesOpt)compressCoder.QueryInterface(typeof(CompressSetCoderPropertiesOpt));
                compressSetCoderPropertiesOpt.SetCoderPropertiesOpt(properties);
                var encoder = new Lzma2Encoder(compressCoder, compressWriteCoderProperties);
                success = true;
                return encoder;
            }
            finally
            {
                ...
                compressSetCoderPropertiesOpt?.Dispose();
                compressSetCoderProperties?.Dispose();
            }
        }

        /// <summary>
        /// Reads the uncompressed data from the input stream, encodes it with LZMA2, and writes the compressed data to the output stream.
        /// </summary>
