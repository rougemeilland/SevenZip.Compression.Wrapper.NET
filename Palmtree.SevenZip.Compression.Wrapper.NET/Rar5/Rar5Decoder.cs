...
namespace SevenZip.Compression.Rar5
{
    /// <summary>
    /// A class of Rar5 decoders.
    /// </summary>
    public class Rar5Decoder
        : IDisposable
    {
        /// <summary>
        ...
        private Rar5Decoder(CompressCoder compressCoder)
        {
            _isDisposed = false;
        ...
        /// <summary>
        /// Create an instance of <see cref="Rar5Decoder"/> with default properties.
        /// </summary>
        /// <param name="contentProperties">
        /// <para>
        /// Set the data that represents the parameters of the compressed data in Rar5 format.
        /// </para>
        /// <para>
        ...
        /// </param>
        /// <returns>
        /// It is an instance of <see cref="Rar5Decoder"/> created.
        /// </returns>
        public static Rar5Decoder CreateDecoder(ReadOnlySpan<Byte> contentProperties) => CreateDecoder(new Rar5DecoderProperties(), contentProperties);

        /// <summary>
        /// Create an instance of <see cref="Rar5Decoder"/>.
        /// </summary>
        /// <param name="properties">
        /// Set a property container object to customize the behavior of the Rar5 decoder.
        /// </param>
        /// <param name="contentProperties">
        /// <para>
        /// Set the data that represents the parameters of the compressed data in Rar5 format.
        ...
        public static Rar5Decoder CreateDecoder(Rar5DecoderProperties properties, ReadOnlySpan<Byte> contentProperties)
        {
        ...
        /// <summary>
        /// Read the compressed data from the input stream, decode it with Rar5, and write the uncompressed data to the output stream.
        /// </summary>
