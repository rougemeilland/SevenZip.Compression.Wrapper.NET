...
namespace SevenZip.Compression.Ppmd7
{
        ...
        : IDisposable, ICompressCoder, ICompressGetInStreamProcessedSize
    {
        ...
        /// <summary>
        /// Create an instance of <see cref="Ppmd7Decoder"/> with default properties.
        /// </summary>
        ...
        /// </returns>
        public static Ppmd7Decoder CreateDecoder(ReadOnlySpan<Byte> contentProperties) => CreateDecoder(new Ppmd7DecoderProperties(), contentProperties);
        ...
        public static Ppmd7Decoder CreateDecoder(Ppmd7DecoderProperties properties, ReadOnlySpan<Byte> contentProperties)
        {
        ...
        public static ICompressDecoderStream CreateDecoderStream(
            ...
            => CreateDecoderStream(compressedInStream, new Ppmd7DecoderProperties(), uncompressedOutStreamSize, contentProperties, leaveOpen);
        ...
        public static ICompressDecoderStream CreateDecoderStream(
            ISequentialInputByteStream compressedInStream,
            Ppmd7DecoderProperties properties,
            UInt64? uncompressedOutStreamSize,
            ReadOnlySpan<Byte> contentProperties,
            Boolean leaveOpen = false)
        {
