...
namespace SevenZip.Compression.Deflate
{
        ...
        : IDisposable, ICompressCoder
    {
        ...
        private DeflateEncoder(CompressCoder compressCoder)
        {
            _isDisposed = false;
        ...
        /// <summary>
        /// Create an instance of <see cref="DeflateEncoder"/> with default properties.
        /// </summary>
        /// <returns>
        /// It is an instance of <see cref="DeflateEncoder"/> created.
        /// </returns>
        public static DeflateEncoder CreateEncoder() => CreateEncoder(new DeflateEncoderProperties());
        ...
        public static DeflateEncoder CreateEncoder(DeflateEncoderProperties properties)
        {
