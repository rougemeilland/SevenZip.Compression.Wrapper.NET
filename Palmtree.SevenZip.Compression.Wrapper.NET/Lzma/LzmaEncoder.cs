...
namespace SevenZip.Compression.Lzma
{
        ...
        : IDisposable, ICompressCoder
    {
        ...
        /// </summary>
        public const Int32 LZMA_CONTENT_PROPERTY_SIZE = LzmaConstants.LZMA_CONTENT_PROPERTY_SIZE;

        private const String _coderName = LzmaConstants.CoderName;
        ...
        private LzmaEncoder(CompressCoder compressCoder, CompressWriteCoderProperties compressWriteCoderProperties)
        {
            _isDisposed = false;
        ...
        /// <summary>
        /// Create an instance of <see cref="LzmaEncoder"/> with default properties.
        /// </summary>
        /// <returns>
        /// It is an instance of <see cref="LzmaEncoder"/> created.
        /// </returns>
        public static LzmaEncoder CreateEncoder() => CreateEncoder(new LzmaEncoderProperties());
