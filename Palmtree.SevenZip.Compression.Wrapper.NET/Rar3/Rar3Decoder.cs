...
namespace SevenZip.Compression.Rar3
{
    /// <summary>
    /// A class of Rar3 decoders.
    /// </summary>
    public class Rar3Decoder
        : IDisposable
    {
        /// <summary>
        /// The length of the property embedded in the compressed stream in Rar3 format.
        /// </summary>
        public const Int32 RAR3_CONTENT_PROPERTY_SIZE = Rar3Constants.RAR3_CONTENT_PROPERTY_SIZE;

        private const String _coderName = Rar3Constants.CoderName;

        private readonly CompressCoder _compressCoder;

        private Boolean _isDisposed;

        private Rar3Decoder(CompressCoder compressCoder)
        {
            _isDisposed = false;
        ...
        /// <summary>
        /// Create an instance of <see cref="Rar3Decoder"/> with default properties.
        /// </summary>
        /// <param name="contentProperties">
        /// <para>
        /// Set the data that represents the parameters of the compressed data in Rar3 format.
        /// </para>
        /// <para>
        ...
        /// </param>
        /// <returns>
        /// It is an instance of <see cref="Rar3Decoder"/> created.
        /// </returns>
        public static Rar3Decoder CreateDecoder(ReadOnlySpan<Byte> contentProperties) => CreateDecoder(new Rar3DecoderProperties(), contentProperties);

        /// <summary>
        /// Create an instance of <see cref="Rar3Decoder"/>.
        /// </summary>
        /// <param name="properties">
        /// Set a property container object to customize the behavior of the Rar3 decoder.
        /// </param>
        /// <param name="contentProperties">
        /// <para>
        /// Set the data that represents the parameters of the compressed data in Rar3 format.
        ...
        public static Rar3Decoder CreateDecoder(Rar3DecoderProperties properties, ReadOnlySpan<Byte> contentProperties)
        {
            if (properties is null)
                throw new ArgumentNullException(nameof(properties));
            if (contentProperties.Length != RAR3_CONTENT_PROPERTY_SIZE)
                throw new ArgumentException($"{nameof(contentProperties)} is not {RAR3_CONTENT_PROPERTY_SIZE} bytes long.: length={contentProperties.Length}", nameof(contentProperties));
            ...
            try
            {
                ...
                var decoder = new Rar3Decoder(compressCoder);
                success = true;
                return decoder;
            }
            finally
        ...
        /// <summary>
        /// Read the compressed data from the input stream, decode it with Rar3, and write the uncompressed data to the output stream.
        /// </summary>
