...
{
    /// <summary>
    /// A class of PPMd8 (PPMd version I) encoders.
    /// </summary>
        ...
        : IDisposable
    {
        ...
        private Ppmd8Encoder(CompressCoder compressCoder)
        {
            _isDisposed = false;
        ...
        /// <summary>
        /// Create an instance of <see cref="Ppmd8Encoder"/> with default properties.
        /// </summary>
        /// <returns>
        /// It is an instance of <see cref="Ppmd8Encoder"/> created.
        /// </returns>
        public static Ppmd8Encoder CreateEncoder() => CreateEncoder(new Ppmd8EncoderProperties());
        ...
        public static Ppmd8Encoder CreateEncoder(Ppmd8EncoderProperties properties)
        {
