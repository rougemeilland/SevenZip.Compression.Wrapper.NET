...
namespace SevenZip.Compression.Rar2
{
    /// <summary>
    /// A class of Rar2 decoders.
    /// </summary>
    public class Rar2Decoder
        : IDisposable
    {
        /// <summary>
        /// The length of the property embedded in the compressed stream in Rar2 format.
        /// </summary>
        public const Int32 RAR2_CONTENT_PROPERTY_SIZE = Rar2Constants.RAR2_CONTENT_PROPERTY_SIZE;

        private const String _coderName = Rar2Constants.CoderName;

        private readonly CompressCoder _compressCoder;

        private Boolean _isDisposed;

        private Rar2Decoder(CompressCoder compressCoder)
        {
            _isDisposed = false;
        ...
        /// <summary>
        /// Create an instance of <see cref="Rar2Decoder"/> with default properties.
        /// </summary>
        /// <param name="contentProperties">
        /// <para>
        /// Set the data that represents the parameters of the compressed data in Rar2 format.
        /// </para>
        /// <para>
        ...
        /// </param>
        /// <returns>
        /// It is an instance of <see cref="Rar2Decoder"/> created.
        /// </returns>
        public static Rar2Decoder CreateDecoder(ReadOnlySpan<Byte> contentProperties) => CreateDecoder(new Rar2DecoderProperties(), contentProperties);

        /// <summary>
        /// Create an instance of <see cref="Rar2Decoder"/>.
        /// </summary>
        /// <param name="properties">
        /// Set a property container object to customize the behavior of the Rar2 decoder.
        /// </param>
        /// <param name="contentProperties">
        /// <para>
        /// Set the data that represents the parameters of the compressed data in Rar2 format.
        ...
        public static Rar2Decoder CreateDecoder(Rar2DecoderProperties properties, ReadOnlySpan<Byte> contentProperties)
        {
            if (properties is null)
                throw new ArgumentNullException(nameof(properties));
            if (contentProperties.Length != RAR2_CONTENT_PROPERTY_SIZE)
                throw new ArgumentException($"{nameof(contentProperties)} is not {RAR2_CONTENT_PROPERTY_SIZE} bytes long.: length={contentProperties.Length}", nameof(contentProperties));
            ...
            try
            {
                ...
                var decoder = new Rar2Decoder(compressCoder);
                success = true;
                return decoder;
            }
            finally
        ...
        /// <summary>
        /// Read the compressed data from the input stream, decode it with Rar2, and write the uncompressed data to the output stream.
        /// </summary>
