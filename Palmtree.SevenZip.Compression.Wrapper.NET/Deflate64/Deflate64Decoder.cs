...
namespace SevenZip.Compression.Deflate64
{
        ...
        : IDisposable, ICompressCoder, ICompressGetInStreamProcessedSize, ICompressReadUnusedFromInBuf
    {
        ...
        /// <summary>
        /// Create an instance of <see cref="Deflate64Decoder"/> with default properties.
        /// </summary>
        /// <returns>
        /// It is an instance of <see cref="Deflate64Decoder"/> created.
        /// </returns>
        public static Deflate64Decoder CreateDecoder() => CreateDecoder(new Deflate64DecoderProperties());
        ...
        public static Deflate64Decoder CreateDecoder(Deflate64DecoderProperties properties)
        {
            ...
            try
            {
                compressCoder = CompressCodecsCollection.Instance.CreateCompressCoder(Deflate64Constants.CODER_NAME, CoderType.Decoder);
        ...
        public static ICompressDecoderStreamWithICompressReadUnusedFromInBuf CreateDecoderStream(
            ...
            => CreateDecoderStream(compressedInStream, new Deflate64DecoderProperties(), uncompressedOutStreamSize, leaveOpen);
        ...
        public static ICompressDecoderStreamWithICompressReadUnusedFromInBuf CreateDecoderStream(
            ISequentialInputByteStream compressedInStream,
            Deflate64DecoderProperties properties,
            UInt64? uncompressedOutStreamSize,
            Boolean leaveOpen = false)
        {
            if (compressedInStream is null)
