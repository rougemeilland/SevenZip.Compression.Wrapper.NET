...
namespace SevenZip.Compression.Deflate64
{
        ...
        : IDisposable, ICompressCoder
    {
        ...
        private Deflate64Encoder(CompressCoder compressCoder)
        {
            _isDisposed = false;
        ...
        /// <summary>
        /// Create an instance of <see cref="Deflate64Encoder"/> with default properties.
        /// </summary>
        /// <returns>
        /// It is an instance of <see cref="Deflate64Encoder"/> created.
        /// </returns>
        public static Deflate64Encoder CreateEncoder() => CreateEncoder(new Deflate64EncoderProperties());
        ...
        public static Deflate64Encoder CreateEncoder(Deflate64EncoderProperties properties)
        {
            ...
            try
            {
                compressCoder = CompressCodecsCollection.Instance.CreateCompressCoder(Deflate64Constants.CODER_NAME, CoderType.Encoder);
                ...
                var encoder = new Deflate64Encoder(compressCoder);
                success = true;
                return encoder;
            }
            finally
